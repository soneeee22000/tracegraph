...
print(f"Sources: {len(result['citations'])}")  # Sources: 10`,
  ...
  typescript: `const response = await fetch("http://localhost:8000/query", {
  method: "POST",
...
export function CodeExample() {
  ...
  return (
    <section ref={sectionRef} id="api" className="py-24 lg:py-32 bg-[#111113] border-y border-[rgba(255,255,255,0.06)]">
          ...
          <Tabs defaultValue="python" className="w-full">
            ...
            <div className="code-block rounded-t-none rounded-b-2xl border border-t-0 border-[rgba(255,255,255,0.06)] p-6">
              ...
              <TabsContent value="typescript" className="mt-0">
                <SyntaxHighlight code={codeExamples.typescript} language="typescript" />
              </TabsContent>
            </div>
          </Tabs>
        </div>
