...
const features: Feature[] = [
    ...
    visual: (
      <div className="mt-6 space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <span className="px-2.5 py-1 rounded-full text-xs bg-[#6366f1]/10 text-[#6366f1] border border-[#6366f1]/20">
            GraphRAG
          </span>
          <ArrowRight className="size-3 text-[#52525b]" />
          <span className="px-2.5 py-1 rounded-full text-xs bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20">
            Knowledge Graph
          </span>
          <ArrowRight className="size-3 text-[#52525b]" />
          <span className="px-2.5 py-1 rounded-full text-xs bg-[#3b82f6]/10 text-[#3b82f6] border border-[#3b82f6]/20">
          ...
          <div
            ...
            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs ${
              i === 0
                ...
                : "bg-[#18181b] text-[#52525b] border border-[rgba(255,255,255,0.06)]"
            }`}
          >
            <span
              className={`size-1.5 rounded-full ${i === 0 ? "bg-[#6366f1]" : "bg-[#52525b]"}`}
            />
            {mode}
          </div>
        ))}
    ...
    visual: (
      <div className="mt-4 grid grid-cols-2 gap-2">
        <div className="p-3 rounded-lg bg-[#ef4444]/5 border border-[#ef4444]/20">
          <div className="text-xs text-[#ef4444] mb-1">Naive RAG</div>
          <div className="h-1 w-full bg-[#ef4444]/30 rounded" />
          <div className="h-1 w-3/4 bg-[#ef4444]/20 rounded mt-1" />
          <div className="text-[9px] text-[#52525b] mt-2">No graph</div>
        </div>
        <div className="p-3 rounded-lg bg-[#10b981]/5 border border-[#10b981]/20">
          <div className="text-xs text-[#10b981] mb-1">GraphRAG</div>
          <div className="h-1 w-full bg-[#10b981]/40 rounded" />
          <div className="h-1 w-3/4 bg-[#10b981]/40 rounded mt-1" />
          <div className="text-[9px] text-[#10b981]/60 mt-2">+ Citations</div>
        </div>
      </div>
    ),
  },
  ...
  {
    badge: { text: "COMFORTABLE", color: "blue" },
    ...
    visual: (
      <div className="mt-4 flex items-center gap-1">
        <div className="h-12 flex-1 rounded-l-lg bg-[#6366f1]/10 border border-[#6366f1]/20 flex items-center justify-center">
          <span className="text-[9px] text-[#6366f1]">Graph</span>
        </div>
        <div className="h-12 w-1 bg-[#6366f1]/40 rounded cursor-col-resize" />
        <div className="h-12 flex-1 rounded-r-lg bg-[#18181b] border border-[rgba(255,255,255,0.06)] flex flex-col items-center justify-center gap-0.5">
          <span className="text-[8px] text-[#52525b]">Response</span>
          <div className="w-8 h-px bg-[#6366f1]/40" />
          <span className="text-[8px] text-[#52525b]">Citations</span>
        </div>
      </div>
    ),
  },
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mt-4 text-lg text-[#a1a1aa] leading-relaxed">
            From entity extraction to citation trails, TraceGraph provides the
            complete toolkit for explainable AI.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              {/* Badge */}
              <span
                className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-medium uppercase tracking-wider border ${
